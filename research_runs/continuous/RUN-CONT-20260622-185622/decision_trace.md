...
- Prior art remains unverified, so no frontier or novelty claim is promoted.

Main blocker:

- Human/domain validation and external prior-art verification are still required
  before any result can become a paper candidate.
