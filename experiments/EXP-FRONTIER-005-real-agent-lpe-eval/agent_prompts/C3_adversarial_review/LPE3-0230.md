...
- claim_text: Test whether PAGC satisfies the Ryu-Takayanagi formula analog: does the "entanglement entropy" of a subset of PAGC tokens scale with the boundary area of that subset in the 27×8 matrix?
