...
- source_path: papers/nwagu_aneke_articles/008-comparative-standardization/main.tex
- claim_text: For comparative writing systems and standardization studies, the gap is therefore practical and scholarly: reviewers need to see a result that can be checked without accepting the entire PAGC theory.
