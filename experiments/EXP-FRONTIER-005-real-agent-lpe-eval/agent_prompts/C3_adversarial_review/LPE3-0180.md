...
- source_path: research/icegov/contradictions/CONT-006.md
- claim_text: The values must be either: - Removed and replaced with a "design science" framing - Or explicitly labelled as "hypothetical example values for illustration only" **Unblock condition:** Paper v3 must restructure Section 6.
