...
- claim_text: It claims that a writing system "revealed by ancestors" to an illiterate Nigerian farmer contains a universal generative engine — a claim that inverts the colonial hierarchy of knowledge validation.
