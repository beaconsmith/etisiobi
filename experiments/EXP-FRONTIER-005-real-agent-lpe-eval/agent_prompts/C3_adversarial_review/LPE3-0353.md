...
- source_path: external_prior_art/Web Annotation
- claim_text: Web Annotation should be treated as a comparator, not as evidence that Layer Promotion Error is solved.
