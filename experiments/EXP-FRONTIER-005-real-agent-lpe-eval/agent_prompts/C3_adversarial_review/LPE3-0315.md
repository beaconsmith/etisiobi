...
- source_path: research/pagc/applications/oroma_product_tickets.md
- claim_text: Credential export creates event with credentialType, evidenceEventCount, and exportTarget.
