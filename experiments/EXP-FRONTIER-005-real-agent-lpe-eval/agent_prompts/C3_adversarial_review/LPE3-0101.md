...
- claim_text: It reports the audit described here and uses that result to define a defensible contribution for Unicode proposal track / digital humanities methods venues.
