...
| a selector-layer sample can map ten records into TEI/Web Annotation leads while pixel coordinates remain outside the approved claim | PASS | Article-specific experiment output |
