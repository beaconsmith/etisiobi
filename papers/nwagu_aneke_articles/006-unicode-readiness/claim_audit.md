...
| a Unicode-readiness gap matrix identifies present, partial, blocked, and missing requirements without becoming a proposal | PASS | Article-specific experiment output |
