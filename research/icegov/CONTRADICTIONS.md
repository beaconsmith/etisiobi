...
**Proposed mitigation (already in v5):** Require proposalId reference in purpose field —
...
**Status:** Open — significant design gap for journal version.
...
**Status:** Open — add as explicit scope condition in journal version §3 or §8 Threats.
