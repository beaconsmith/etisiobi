\documentclass[review,onecolumn]{elsarticle}
...
\begin{keyword}
Community Governance \sep Digital Governance Measurement \sep Accountability \sep Southeast Nigeria \sep Verifiable Records \sep Records Management
\end{keyword}
...
Community scorecards and related social-accountability tools are useful comparators, but they usually assess an external provider or state delegate rather than the community institution itself \cite{cooke2001,bjorkman2009}. The CDGI Framework instead treats the community as the record producer and treasury operator. Recent electronic governance work on local online services remains concentrated on municipal portals rather than community-governance records \cite{gasco2017,janowski2015}, leaving a below-the-state measurement gap.
...
The framework has direct policy relevance for digital government research. In Nigeria, agencies such as NITDA could use CDGI-Core as a readiness diagnostic for community-facing digital-governance programmes, especially where interventions depend on documented treasury, participation, and dispute workflows. Communities with weak RV-01 or DRL-01 scores are not simply ``low capacity'' in the abstract; they have identifiable documentary gaps that can be addressed through record-keeping standards, export requirements, and dispute-workflow design.

For development partners such as the World Bank and UNDP, the framework offers an ex-ante assessment tool for community-layer digital infrastructure and local-governance initiatives. Communities with weak RV-01 or TTI-01 scores need recordkeeping support before larger-scale funding or platform roll-out; communities with stronger scores are better candidates for more advanced portability or privacy-preserving treasury workflows. This shifts evaluation from ex-post audit failure toward ex-ante governance readiness.
...
During the preparation of this work the author used the Antigravity AI coding assistant in order to assist with LaTeX formatting, structural refinement, and technical proofreading. After using this tool, the author reviewed and edited the content as needed and takes full responsibility for the content of the publication.

\section*{Ethics Statement}

The study protocol was reviewed and approved by an Institutional Review Board (IRB) at the author's home institution. All participants provided informed consent. Data management followed the CARE Principles for Indigenous Data Governance \cite{carroll2020}.

\section*{Funding Disclosure}

This research was self-funded by Beaconsmith Collective Labs. No external funding body had any role in study design, data collection, analysis, decision to publish, or manuscript preparation.
