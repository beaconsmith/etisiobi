...
> *Draft v6 — Post-submission research integration. Base: v5 (double-blind, submitted). V6 incorporates v6 autoresearch findings: empirical threshold calibration, five new sources, six active contradictions documented for Delphi validation.*
