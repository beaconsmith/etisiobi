...
%% ICIS 2026 — International Conference on Information Systems
%% Lisbon, Portugal, December 13–16, 2026
%% Double-blind submission — all identifying information removed
\acmConference[ICIS '26]{International Conference on Information Systems}{December 13--16, 2026}{Lisbon, Portugal}
\acmBooktitle{ICIS 2026 Proceedings}
\acmDOI{}
\acmISBN{}
...
The study protocol was reviewed by an Institutional Review Board (protocol number withheld for anonymous review). All participants provided informed consent. Data management followed the CARE Principles for Indigenous Data Governance \cite{carroll2020}.

Detailed positionality and funding disclosures are reserved for the camera-ready version to preserve double-blind review.
