...
\title{Digital Sovereignty and Institutional Memory in Community Governance: Designing Resilient Records for Informal Associations}

\author{Anonymous Author(s)}
\affiliation{\institution{Anonymous for review}}

\begin{abstract}
Informal community associations frequently suffer from 'institutional amnesia' when leadership changes or physical records are lost. This paper applies the concept of digital sovereignty to the challenge of community institutional memory. Drawing on Indigenous data sovereignty principles (OCAP/CARE), we propose a framework for the design of resilient, community-controlled record systems. We argue that digital sovereignty at the community scale requires not just data control, but also data continuity and recoverability independent of specific operators or state actors.
\end{abstract}

\ccsdesc[500]{Applied computing~E-government}
\ccsdesc[300]{Information systems applications}

\keywords{Digital Sovereignty, Institutional Memory, Community Governance, Resilience, Data Control}
