...
\title{Governing Community Financial Coordination Platforms: Public-Private Lessons from a Bitcoin-Native Governance Stack}

\author{Anonymous Author(s)}
\affiliation{\institution{Anonymous for review}}

\begin{abstract}
The governance of community financial platforms remains under-theorized, caught between the logic of corporate fintech and state bureaucratic regulation. This paper extracts governance lessons from the development of a Bitcoin-native coordination stack for community finance. We analyze the accountability requirements of platform operators and propose a stewardship framework that balances technical functionality with public-interest goals. We draw on lessons from public-private partnerships (PPPs) and platform governance literature to define the fiduciary responsibilities of community-layer technology providers.
\end{abstract}

\ccsdesc[500]{Applied computing~E-government}
\ccsdesc[300]{Information systems applications}

\keywords{Platform Governance, Community Finance, Accountability, Stewardship, Public-Private Partnership}
