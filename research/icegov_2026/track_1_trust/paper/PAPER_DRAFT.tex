...
\title{From Recall to Receipts: Building Trust in Community Governance through Artifact-First Digital Records}

\author{Anonymous Author(s)}
\affiliation{\institution{Anonymous for review}}

\begin{abstract}
Trust in community governance often relies on fragile individual recall and interpersonal relationships, which are vulnerable to disruption during leadership transitions or disputes. This paper proposes an 'artifact-first' design philosophy for digital records, drawing on procedural justice theory and records-management standards (ISO 15489). We argue that verifiable digital receipts and cryptographically anchored audit trails can generate institutional trust more effectively than promises of transparency alone. We present a framework for record integrity in community-layer systems and evaluate its potential for strengthening the legitimacy of informal associations.
\end{abstract}

\ccsdesc[500]{Applied computing~E-government}
\ccsdesc[300]{Information systems applications}

\keywords{Trust, Digital Records, Procedural Justice, Artifact-First Design, Community Governance}
