...
\title{Verifiable Community Treasury Operations on Bitcoin Rails: A Design Framework for Transparent Collective Finance}

\author{Anonymous Author(s)}
\affiliation{\institution{Anonymous for review}}

\begin{abstract}
Decentralized finance (DeFi) often ignores the needs of community-layer financial institutions like rotating savings groups (esusu) in the Global South. This paper introduces a design framework for verifiable community treasury operations built on Bitcoin-native infrastructure. We prioritize settlement finality and censorship resistance over speculative tokenomics. Applying design-science methodology, we demonstrate how 'Bitcoin rails' can provide a robust settlement layer for community-governed funds, ensuring transparency and auditability without requiring dependence on centralized banking intermediaries or fragile local record systems.
\end{abstract}

\ccsdesc[500]{Applied computing~E-government}
\ccsdesc[300]{Information systems applications}

\keywords{Bitcoin, Collective Finance, Verifiability, Community Treasury, Design Science}
