...
\title{Early Evidence from a Community Operating System for Verifiable Local Governance}

\author{Anonymous Author(s)}
\affiliation{\institution{Anonymous for review}}

\begin{abstract}
Bridging the gap between theoretical governance frameworks and practical community needs requires iterative design and testing. This paper presents early evidence from the deployment of a 'Community Operating System' (COS) designed for verifiable local governance in Southeast Nigeria. Following action design research (ADR) principles, we report on the feasibility, usability, and initial governance-relevance indicators of the system. We discuss the socio-technical barriers encountered during the pilot phase and refine our design theory for community-layer governance artifacts based on these early field observations.
\end{abstract}

\ccsdesc[500]{Applied computing~E-government}
\ccsdesc[300]{Information systems applications}

\keywords{Community Operating System, Verifiable Governance, Design Science, Pilot Evaluation, Early Evidence}
